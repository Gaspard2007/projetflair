...
<div className='flex flex-col'>
    ...
    <div className='flex flex-row justify-between' style={{ width: '250px' }}>
        ...
        <h4 className='flex justify-end'>69,40 €</h4>
    </div>
    <div className='bg-gray-200 w-full h-0.5'></div>
    <div className='flex flex-row justify-between' style={{ width: '250px' }}>
        <h4 className='flex justify-start'>TOTAL TTC</h4>
        <h4 className='flex justify-end'>416, 40 €</h4>
    </div>
    <br />
    <div>
        <Link href={'/boutique/location/etape-validation-de-commande'}><button style={{paddingTop:'12px',paddingRight:'17px', paddingLeft:'17px', paddingBottom:'12px'}} className='bg-black text-lg text-white'>VALIDER LA COMMANDE</button></Link>
    </div>
</div>
</div>
</div>
