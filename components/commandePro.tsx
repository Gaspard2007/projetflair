  ...
  const CommandeDuPro: React.FC = () => {
    ...
    <Column
        ...
        render={(text, record: DataType) => (
          <Link href={'/dashboard_pro/commandes/detailsCommande'}><button className='bg-black text-white text-sm rounded cursor-pointer' style={{padding:'9px'}}  onClick={() => handleVoir(record)}>
          Voir
        </button></Link>
        )}
      />
