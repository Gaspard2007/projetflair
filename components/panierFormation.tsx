...
<div className='flex flex-col'>
    ...
    <br />
    <div>
        <Link href={'/boutique/formation/paypal'}><button style={{paddingTop:'12px',paddingRight:'17px', paddingLeft:'17px', paddingBottom:'12px'}} className='bg-black text-lg text-white'>VALIDER LA COMMANDE</button></Link>
    </div>
</div>
</div>
</div>
