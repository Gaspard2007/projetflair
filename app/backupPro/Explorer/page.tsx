...
import CardAbonnementAnnuel from '@/components/cardAbonnementAnnuel';
    ...
    <div>
      ...
      <div>
        ...
        <Row className='flex justify-center items-center'>
          <Col span={8}><CardProfessionnel /></Col>
          <Col span={8}><CardProfessionnel /></Col>
          <Col span={8}><CardProfessionnel /></Col>
        </Row>
      </div>
      <br />
      <div className='flex justify-center'>
        <Link href={'/backupPro/ArchivePro'}><button className='bg-black text-white text-lg' style={{padding:'11px'}}>Voir plus</button></Link>
      </div>
